...
def generate_track(curve: FCurve, fps: int) -> et.Element:
...
def generate_tracks(obj: Object, fps: int) -> List[et.Element]:
    tracks = []
...
def export_xpf(context: Context, filepath: str, fps: int, frames: int):
    animated_objs = []
